...
export default function HomePage() {
  return (
    <main className="max-w-80 md:max-w-4xl mx-auto font-light items-center self-center justify-center bg-ivory text-charcoal pt-40 pb-[50vh]">
      <div className="flex flex-col items-center justify-center text-center">
        {/* Profile Picture Placeholder */}
        <div className="w-64 h-64 rounded-full bg-gray-200 mb-8 mt-12">
          {/* Image will go here */}
        </div>
          ...
          <div className="border border-gray-200 rounded-lg bg-white shadow-sm p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <a 
                ...
                className="flex flex-col items-center p-4 rounded-lg hover:bg-gray-50 transition-colors duration-200 group"
              >
                <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-100 mb-3 group-hover:bg-gray-200 transition-colors duration-200">
                ...
                <span className="text-sm font-medium text-gray-900 mb-1">GitHub</span>
                <span className="text-sm text-gray-500">@hgleung</span>
              </a>
