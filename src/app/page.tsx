      ...
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <div className="flex space-x-3 mt-4">
          <a 
            ...
            className="inline-flex items-center px-4 py-2 rounded-full text-sm font-light text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200"
          >
